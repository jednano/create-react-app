...
describe('formats various webpack errors correctly', () => {
  ...
  it('export not found', () => {
    const json = {
      errors: [
        "./template/src/entries/index.js 1:182-185\n\"export 'App' was not found in './App'\n @ multi ./config/polyfills.js ./template/src/entries/index.js",
      ],
      warnings: [],
    };
